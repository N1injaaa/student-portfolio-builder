...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  "auth.tryAgain": "Try again",
    ...
    "entryEditor.moveUp": "Move up",
    "entryEditor.moveDown": "Move down",
    "entryEditor.edit": "Edit",
    "entryEditor.delete": "Delete",

    "a11y.customAccentColor": "Custom accent color",
  ...
  ru: {
    ...
    // Entry list editor chrome
    "entryEditor.editing": "Редактирование записи:",
    "entryEditor.new": "Новая запись:",
    ...
    "entryEditor.addFirstPrefix": "+ Добавить первую запись:",
    "entryEditor.deleteConfirmTitle": "Удалить запись «",
    "entryEditor.deleteConfirmSuffix": "»?",
    ...
    "entryEditor.moveUp": "Переместить вверх",
    "entryEditor.moveDown": "Переместить вниз",
    "entryEditor.edit": "Редактировать",
    "entryEditor.delete": "Удалить",

    "a11y.customAccentColor": "Свой акцентный цвет",
    "a11y.dismissNotification": "Закрыть уведомление",

    "resumeSettings.versionsTitle": "Версии резюме",
    "resumeSettings.versionsHint":
      "Сохрани текущий шаблон и разделы как именованную версию — удобно для подгонки резюме под каждую вакансию.",
    "resumeSettings.default": "По умолчанию",
    "resumeSettings.deleteVersion": "Удалить версию",
    "resumeSettings.namePlaceholder": "например, Стажировка Frontend",
    "resumeSettings.saveAsNew": "Сохранить как новую версию",
    "resumeSettings.freeLimitPrefix": "🔒 На бесплатном тарифе доступна 1 сохранённая версия.",
    "resumeSettings.upgrade": "Перейти на Pro",
    "resumeSettings.freeLimitSuffix": "чтобы сохранять больше.",
    "resumeSettings.templateTitle": "Шаблон",
    "resumeSettings.moreTemplatesPrefix": "🔒 Ещё 3 шаблона доступны в",
    "resumeSettings.pro": "Pro",
    "resumeSettings.templateNote.minimal": "Спокойный шрифт, одна колонка",
    "resumeSettings.templateNote.modern": "Жирный акцентный заголовок",
    "resumeSettings.templateNote.academic": "Серифный шрифт, стиль транскрипта",
    "resumeSettings.templateNote.professional": "Две колонки, плотная вёрстка",
    "resumeSettings.typographyTitle": "Типографика и отступы",
    "resumeSettings.font": "Шрифт",
    "resumeSettings.fontSize": "Размер шрифта",
    "resumeSettings.spacing": "Отступы",
    "resumeSettings.sans": "Рубленый",
    "resumeSettings.serif": "Серифный",
    "resumeSettings.mono": "Моноширинный",
    "resumeSettings.small": "Маленький",
    "resumeSettings.medium": "Средний",
    "resumeSettings.large": "Крупный",
    "resumeSettings.compact": "Компактные",
    "resumeSettings.comfortable": "Комфортные",
    "resumeSettings.roomy": "Просторные",
    "resumeSettings.accentColorTitle": "Акцентный цвет",
    "resumeSettings.useAccentColor": "Выбрать акцентный цвет",
    "resumeSettings.sectionsTitle": "Показать / скрыть разделы",

    "resumeSettings.versionsTitle": "Resume versions",
    "resumeSettings.versionsHint":
      "Save the current template & sections as a named version — handy for tailoring one resume per application.",
    "resumeSettings.default": "Default",
    "resumeSettings.deleteVersion": "Delete version",
    "resumeSettings.namePlaceholder": "e.g. Frontend internship",
    "resumeSettings.saveAsNew": "Save as new version",
    "resumeSettings.freeLimitPrefix": "🔒 Free accounts keep 1 saved version.",
    "resumeSettings.upgrade": "Upgrade",
    "resumeSettings.freeLimitSuffix": "for more.",
    "resumeSettings.templateTitle": "Template",
    "resumeSettings.moreTemplatesPrefix": "🔒 3 more templates are available on",
    "resumeSettings.pro": "Pro",
    "resumeSettings.templateNote.minimal": "Quiet type, single column",
    "resumeSettings.templateNote.modern": "Bold accent header",
    "resumeSettings.templateNote.academic": "Serif, transcript-style",
    "resumeSettings.templateNote.professional": "Two-column, dense",
    "resumeSettings.typographyTitle": "Typography & spacing",
    "resumeSettings.font": "Font",
    "resumeSettings.fontSize": "Font size",
    "resumeSettings.spacing": "Spacing",
    "resumeSettings.sans": "Sans",
    "resumeSettings.serif": "Serif",
    "resumeSettings.mono": "Mono",
    "resumeSettings.small": "Small",
    "resumeSettings.medium": "Medium",
    "resumeSettings.large": "Large",
    "resumeSettings.compact": "Compact",
    "resumeSettings.comfortable": "Comfortable",
    "resumeSettings.roomy": "Roomy",
    "resumeSettings.accentColorTitle": "Accent color",
    "resumeSettings.useAccentColor": "Use accent color",
    "resumeSettings.sectionsTitle": "Show / hide sections",
